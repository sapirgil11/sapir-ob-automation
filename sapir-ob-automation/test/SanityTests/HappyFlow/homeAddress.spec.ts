...
test.describe('🏠 Home Address Page Tests', () => {
    test('🏠 Home Address Page - Complete Home Address Flow', async ({ page, context }) => {
        ...
        // Wait for home address page and fill address details
        ...
        await page.waitForURL('**/business-type**', { timeout: 10000 });
        expect(page.url()).toContain('/business-type');
    });
});