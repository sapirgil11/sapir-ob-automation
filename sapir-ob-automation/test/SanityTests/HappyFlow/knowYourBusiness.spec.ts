...
test.describe('🏢 Know Your Business Page Tests', () => {
    test('🏢 Know Your Business Page - Complete KYB Flow', async ({ page, context }) => {
        ...
        // Wait for know your business page and fill KYB details
        ...
        expect(page.url()).toContain('/owners-center');
    });
});