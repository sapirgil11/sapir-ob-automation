...
test.describe('🏢 Business Type Page Tests', () => {
    test('🏢 Business Type Page - Complete Business Type Flow', async ({ page, context }) => {
