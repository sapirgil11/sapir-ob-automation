...
export class IdentityFlow {
    ...
    async testFillIdentityForm(emailPrefix?: string): Promise<boolean> {
        ...
        try {
            ...
            console.log(`❌ Error navigating to Identity page: ${error instanceof Error ? error.message : String(error)}`);
            return false;
        }
    }
    ...
    async fillIdentityForm(ssn?: string, dateOfBirth?: string): Promise<boolean> {
        ...
        try {
            ...
            console.log(`❌ Error filling identity form: ${error instanceof Error ? error.message : String(error)}`);
            return false;
        }
    }
    ...
    async testFillIdentityNumber(): Promise<boolean> {
        ...
        try {
            ...
            console.log(`❌ Error in testFillIdentityNumber: ${error instanceof Error ? error.message : String(error)}`);
            return false;
        }
    }
    ...
    async testBackendError(): Promise<boolean> {
        ...
        try {
            ...
            console.log(`❌ Error in testBackendError: ${error instanceof Error ? error.message : String(error)}`);
            return false;
        }
    }
    ...
    async testFormValidation(): Promise<boolean> {
        ...
        try {
            ...
            console.log(`❌ Error in testFormValidation: ${error instanceof Error ? error.message : String(error)}`);
            return false;
        }
    }
}
