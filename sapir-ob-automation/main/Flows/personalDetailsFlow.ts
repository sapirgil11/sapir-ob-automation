...
export class PersonalDetailsFlow {
  ...
  async navigateToPersonalDetails(emailPrefix?: string): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error navigating to Personal Details page: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async fillPersonalDetailsForm(
    ...
    try {
      ...
      console.log(
        `❌ Error filling personal details form: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
   ...
   * @returns Promise<boolean> - Success status
   */
  async completePersonalDetailsFlow(
    firstName: string = 'John',
    lastName: string = 'Doe'
  ): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error completing personal details flow: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testFirstNameValidation(): Promise<boolean> {
    ...
    try {
      ...
      const hasLettersOnlyError =
        await this.personalDetailsPage.firstNameLettersOnlyError.isVisible();
      ...
      console.log(
        `❌ Error testing first name validation: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testLastNameValidation(): Promise<boolean> {
    ...
    try {
      ...
      const hasLettersOnlyError =
        await this.personalDetailsPage.lastNameLettersOnlyError.isVisible();
      if (!hasLettersOnlyError) {
        console.log('❌ Letters only error not triggered');
        return false;
      }
      ...
      console.log(
        `❌ Error testing last name validation: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testAllValidations(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error testing all validations: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testErrorClearing(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error testing error clearing: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async verifyPageElements(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error verifying page elements: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async getFormValues(): Promise<{ firstName: string; lastName: string }> {
    try {
      ...
      console.log(
        `❌ Error getting form values: ${error instanceof Error ? error.message : String(error)}`
      );
      return { firstName: '', lastName: '' };
    }
  }
  ...
  async isFormReadyForSubmission(): Promise<boolean> {
    try {
      ...
      console.log(
        `❌ Error checking form readiness: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testFillPersonalDetails(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error in testFillPersonalDetails: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testFirstAndLastNameInlineErrors(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `   Button enabled after empty: ${isButtonEnabledAfterEmpty ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      console.log(
        `   Button enabled after min length: ${isButtonEnabledAfterMin ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      console.log(
        `   Button enabled after numbers: ${isButtonEnabledAfterNumbers ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      console.log(
        `   Button enabled after max length: ${isButtonEnabledAfterMax ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      const isButtonEnabledAfterLastNameEmpty =
        await this.personalDetailsPage.isContinueButtonEnabled();
      console.log(`   Empty last name error visible: ${hasLastNameEmptyError ? '✅' : '❌'}`);
      console.log(
        `   Button enabled after empty last name: ${isButtonEnabledAfterLastNameEmpty ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      const hasLastNameMinLengthError =
        await this.personalDetailsPage.lastNameMinLengthError.isVisible();
      const isButtonEnabledAfterLastNameMin =
        await this.personalDetailsPage.isContinueButtonEnabled();
      console.log(
        `   Min length last name error visible: ${hasLastNameMinLengthError ? '✅' : '❌'}`
      );
      console.log(
        `   Button enabled after min length last name: ${isButtonEnabledAfterLastNameMin ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      const hasLastNameLettersOnlyError =
        await this.personalDetailsPage.lastNameLettersOnlyError.isVisible();
      const isButtonEnabledAfterLastNameNumbers =
        await this.personalDetailsPage.isContinueButtonEnabled();
      console.log(
        `   Letters only last name error visible: ${hasLastNameLettersOnlyError ? '✅' : '❌'}`
      );
      console.log(
        `   Button enabled after numbers last name: ${isButtonEnabledAfterLastNameNumbers ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      const hasLastNameMaxLengthError =
        await this.personalDetailsPage.lastNameMaxLengthError.isVisible();
      const isButtonEnabledAfterLastNameMax =
        await this.personalDetailsPage.isContinueButtonEnabled();
      console.log(
        `   Max length last name error visible: ${hasLastNameMaxLengthError ? '✅' : '❌'}`
      );
      console.log(
        `   Button enabled after max length last name: ${isButtonEnabledAfterLastNameMax ? '❌ Should be disabled' : '✅ Correctly disabled'}`
      );
      ...
      console.log(
        `❌ Error in testFirstAndLastNameInlineErrors: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
  ...
  async testElementsExist(): Promise<boolean> {
    ...
    try {
      ...
      console.log(
        `❌ Error in testElementsExist: ${error instanceof Error ? error.message : String(error)}`
      );
      return false;
    }
  }
