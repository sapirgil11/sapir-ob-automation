...
export class TestRunner {
     ...
     */
    async runTests(browserType: 'chromium' | 'firefox' | 'webkit' = 'chromium', headless: boolean = false): Promise<TestResult[]> {
     ...
     */
    async runTestsParallel(browsers: ('chromium' | 'firefox' | 'webkit')[] = ['chromium']): Promise<TestResult[][]> {
