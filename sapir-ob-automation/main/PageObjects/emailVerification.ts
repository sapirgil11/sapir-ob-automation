...
export class EmailVerification {
  ...
  private initializeLocators(): void {
    ...
    // Page content elements
    this.verificationHeading = this.page.getByRole('heading', {
      name: 'Verify Your Email Address',
    });
    this.emailDisplay = this.page.locator('p:has-text("@mailforspam.com")');
    this.enterCodeText = this.page.getByText(
      'Enter it below to confirm your email and continue your application'
    );
    ...
    // Toast messages
    this.resendCodeToast = this.page.locator(
      'div.flex.flex-grow-1.text-\\[13px\\].leading-\\[18px\\].font-metricR.text-text-main-primary'
    );
  }
