...
export class KnowYourBusiness {
    ...
    private initializeElements(): void {
        ...
        this.businessNameClearButton = this.page.locator('#BUSINESS_NAME').locator('xpath=following::*[contains(@aria-label, "Clear") or contains(@id, "clear") or contains(@class, "clear")][1]');

        this.einInput = this.page.locator('#BUSINESS_EIN');
        this.einClearButton = this.page.locator('#BUSINESS_EIN').locator('xpath=following::*[contains(@aria-label, "Clear") or contains(@id, "clear") or contains(@class, "clear")][1]');
