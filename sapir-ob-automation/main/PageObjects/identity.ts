...
export class Identity {
  ...
  private initializeErrorElements(): void {
    ...
    this.ageRestrictionError = this.page.locator(
      'text="Sorry, but you have to be at least 18 to open an account"'
    );
    this.backendError = this.page.locator(
      'text="We\'re sorry, but we cannot open an account for you at this time."'
    );
  }
